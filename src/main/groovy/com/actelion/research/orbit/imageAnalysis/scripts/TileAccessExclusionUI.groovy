 ...
 * Here we load the annotation ROI of the image and use the current exclusion model.
...
ExclusionMapGen exMapGen = ExclusionMapGen.constructExclusionMap(rdf,recognitionFrame,model);
