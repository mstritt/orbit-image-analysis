 ...
 */
public class SetGreenChannel implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_3
        shape = new Ellipse2D.Double(117.29264831542969, 320.0338439941406, 44, 40);
        g.setPaint(MAGENTA);
        g.fill(shape);

        // _0_0_4
        shape = new Ellipse2D.Double(159.62864685058594, 308.8760986328125, 40, 44);
