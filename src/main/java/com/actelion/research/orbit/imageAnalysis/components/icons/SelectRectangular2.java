 ...
 */
public class SelectRectangular2 implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_7
        shape = new Rectangle2D.Double(59.823184967041016, 23.909902572631836, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(56, 4), new Point2D.Double(64, 4), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, 3.8232234f, 23.909903f)));
        g.fill(shape);

        // _0_0_8
        shape = new Rectangle2D.Double(59.999961853027344, 95.91332244873047, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(56, 108), new Point2D.Double(64, 108), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, 4, -8.086679f)));
        g.fill(shape);

        // _0_0_9
        shape = new Rectangle2D.Double(16.08664321899414, 24.44023323059082, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(0, 4), new Point2D.Double(8, 4), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, 16.08668f, 24.440233f)));
        g.fill(shape);

        // _0_0_10
        shape = new Rectangle2D.Double(16.26342010498047, 95.73654174804688, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(0, 108), new Point2D.Double(8, 108), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, 16.263456f, -8.263456f)));
        g.fill(shape);

        // _0_0_11
        shape = new Rectangle2D.Double(104.26683807373047, 25.1473388671875, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(112, 4), new Point2D.Double(120, 4), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, -7.733126f, 25.14734f)));
        g.fill(shape);

        // _0_0_12
        shape = new Rectangle2D.Double(103.91327667236328, 96.26687622070312, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(112, 108), new Point2D.Double(120, 108), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, -8.086679f, -7.733126f)));
        g.fill(shape);

        // _0_0_13
        shape = new Rectangle2D.Double(15.733089447021484, 59.64645004272461, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(0, 56), new Point2D.Double(8, 56), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, 15.733126f, 7.6464467f)));
        g.fill(shape);

        // _0_0_14
        shape = new Rectangle2D.Double(104.09005737304688, 59.82322692871094, 8, 8);
        g.setPaint(new LinearGradientPaint(new Point2D.Double(112, 56), new Point2D.Double(120, 56), new float[]{0, 1}, new Color[]{new Color(0xBBBBBB), new Color(0x888888)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, -7.9099026f, 7.8232236f)));
        g.fill(shape);
