...
public class MRCNNPancreasIslets implements Closeable {

    private static final Logger logger = LoggerFactory.getLogger(MRCNNPancreasIslets.class);
    private static final String MODEL_FN = "D:/insulin/models/insulin_009.pb";
...
//    private static final String OUTPUT_IMAGE = "D:\\NoBackup\\brains\\3\\test-roi-seg.png";
    ...
    // Background + the number of different classes
    public static int numClasses = 1 + 4;
    ...
    public MRCNNPancreasIslets() throws IOException {
