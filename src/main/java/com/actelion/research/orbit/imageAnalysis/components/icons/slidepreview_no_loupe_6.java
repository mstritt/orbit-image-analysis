...
((GeneralPath)shapeText).lineTo(12.472496, 140.73969);
((GeneralPath)shapeText).lineTo(8.810859, 140.73969);
((GeneralPath)shapeText).lineTo(8.810859, 142.92087);
((GeneralPath)shapeText).lineTo(12.317871, 142.92087);
((GeneralPath)shapeText).lineTo(12.317871, 143.7598);
((GeneralPath)shapeText).lineTo(8.810859, 143.7598);
((GeneralPath)shapeText).lineTo(8.810859, 146.43118);
((GeneralPath)shapeText).lineTo(12.561322, 146.43118);
...
((GeneralPath)shapeText).lineTo(15.196517, 146.43118);
((GeneralPath)shapeText).lineTo(18.782486, 146.43118);
...
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(20.827147, 143.74992);
((GeneralPath)shapeText).lineTo(20.827147, 146.45091);
((GeneralPath)shapeText).lineTo(22.42603, 146.45091);
((GeneralPath)shapeText).quadTo(23.22876, 146.45091, 23.616966, 146.11864);
((GeneralPath)shapeText).quadTo(24.005173, 145.78307, 24.005173, 145.09877);
((GeneralPath)shapeText).quadTo(24.005173, 144.4079, 23.616966, 144.07892);
((GeneralPath)shapeText).quadTo(23.22876, 143.74992, 22.42603, 143.74992);
((GeneralPath)shapeText).lineTo(20.827147, 143.74992);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(20.827147, 140.71994);
((GeneralPath)shapeText).lineTo(20.827147, 142.94061);
((GeneralPath)shapeText).lineTo(22.301014, 142.94061);
((GeneralPath)shapeText).quadTo(23.031366, 142.94061, 23.389965, 142.66756);
((GeneralPath)shapeText).quadTo(23.748562, 142.39449, 23.748562, 141.83192);
((GeneralPath)shapeText).quadTo(23.748562, 141.27264, 23.389965, 140.99629);
((GeneralPath)shapeText).quadTo(23.031366, 140.71994, 22.301014, 140.71994);
((GeneralPath)shapeText).lineTo(20.827147, 140.71994);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(19.830313, 139.90076);
((GeneralPath)shapeText).lineTo(22.37668, 139.90076);
((GeneralPath)shapeText).quadTo(23.51498, 139.90076, 24.130188, 140.37451);
((GeneralPath)shapeText).quadTo(24.748686, 140.84825, 24.748686, 141.72336);
((GeneralPath)shapeText).quadTo(24.748686, 142.39778, 24.432856, 142.79915);
((GeneralPath)shapeText).quadTo(24.117027, 143.19722, 23.50511, 143.29591);
((GeneralPath)shapeText).quadTo(24.242043, 143.45383, 24.646698, 143.95718);
((GeneralPath)shapeText).quadTo(25.054644, 144.45724, 25.054644, 145.20734);
((GeneralPath)shapeText).quadTo(25.054644, 146.1943, 24.383509, 146.73384);
...
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(28.98441, 140.55875);
((GeneralPath)shapeText).quadTo(28.214577, 140.55875, 27.82637, 141.31541);
((GeneralPath)shapeText).quadTo(27.438164, 142.07208, 27.438164, 143.59201);
((GeneralPath)shapeText).quadTo(27.438164, 145.10864, 27.82637, 145.86531);
((GeneralPath)shapeText).quadTo(28.214577, 146.622, 28.98441, 146.622);
((GeneralPath)shapeText).quadTo(29.75753, 146.622, 30.145737, 145.86531);
((GeneralPath)shapeText).quadTo(30.533943, 145.10864, 30.533943, 143.59201);
((GeneralPath)shapeText).quadTo(30.533943, 142.07208, 30.145737, 141.31541);
((GeneralPath)shapeText).quadTo(29.75753, 140.55875, 28.98441, 140.55875);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(28.98441, 139.76917);
((GeneralPath)shapeText).quadTo(30.221403, 139.76917, 30.876091, 140.74956);
((GeneralPath)shapeText).quadTo(31.530777, 141.72665, 31.530777, 143.59201);
((GeneralPath)shapeText).quadTo(31.530777, 145.45409, 30.876091, 146.43446);
((GeneralPath)shapeText).quadTo(30.221403, 147.41486, 28.98441, 147.41486);
((GeneralPath)shapeText).quadTo(27.744123, 147.41486, 27.089437, 146.43446);
((GeneralPath)shapeText).quadTo(26.438042, 145.45409, 26.438042, 143.59201);
((GeneralPath)shapeText).quadTo(26.438042, 141.72665, 27.089437, 140.74956);
((GeneralPath)shapeText).quadTo(27.744123, 139.76917, 28.98441, 139.76917);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(35.414482, 140.55875);
((GeneralPath)shapeText).quadTo(34.64465, 140.55875, 34.256443, 141.31541);
((GeneralPath)shapeText).quadTo(33.868237, 142.07208, 33.868237, 143.59201);
((GeneralPath)shapeText).quadTo(33.868237, 145.10864, 34.256443, 145.86531);
((GeneralPath)shapeText).quadTo(34.64465, 146.622, 35.414482, 146.622);
((GeneralPath)shapeText).quadTo(36.187603, 146.622, 36.57581, 145.86531);
((GeneralPath)shapeText).quadTo(36.964016, 145.10864, 36.964016, 143.59201);
((GeneralPath)shapeText).quadTo(36.964016, 142.07208, 36.57581, 141.31541);
((GeneralPath)shapeText).quadTo(36.187603, 140.55875, 35.414482, 140.55875);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(35.414482, 139.76917);
((GeneralPath)shapeText).quadTo(36.651478, 139.76917, 37.306164, 140.74956);
((GeneralPath)shapeText).quadTo(37.96085, 141.72665, 37.96085, 143.59201);
((GeneralPath)shapeText).quadTo(37.96085, 145.45409, 37.306164, 146.43446);
((GeneralPath)shapeText).quadTo(36.651478, 147.41486, 35.414482, 147.41486);
((GeneralPath)shapeText).quadTo(34.1742, 147.41486, 33.51951, 146.43446);
((GeneralPath)shapeText).quadTo(32.868114, 145.45409, 32.868114, 143.59201);
((GeneralPath)shapeText).quadTo(32.868114, 141.72665, 33.51951, 140.74956);
((GeneralPath)shapeText).quadTo(34.1742, 139.76917, 35.414482, 139.76917);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(39.74232, 147.11548);
((GeneralPath)shapeText).lineTo(39.74232, 146.20746);
((GeneralPath)shapeText).quadTo(40.117367, 146.38512, 40.50228, 146.48053);
((GeneralPath)shapeText).quadTo(40.8872, 146.57265, 41.255665, 146.57265);
((GeneralPath)shapeText).quadTo(42.24263, 146.57265, 42.762432, 145.91138);
((GeneralPath)shapeText).quadTo(43.285522, 145.24683, 43.3579, 143.89468);
((GeneralPath)shapeText).quadTo(43.07168, 144.31908, 42.630836, 144.54608);
((GeneralPath)shapeText).quadTo(42.193283, 144.77307, 41.66032, 144.77307);
((GeneralPath)shapeText).quadTo(40.55492, 144.77307, 39.910103, 144.10522);
((GeneralPath)shapeText).quadTo(39.268578, 143.4341, 39.268578, 142.27606);
((GeneralPath)shapeText).quadTo(39.268578, 141.14105, 39.939713, 140.45676);
((GeneralPath)shapeText).quadTo(40.610847, 139.76917, 41.72612, 139.76917);
((GeneralPath)shapeText).quadTo(43.002594, 139.76917, 43.677017, 140.74956);
((GeneralPath)shapeText).quadTo(44.351444, 141.72665, 44.351444, 143.59201);
((GeneralPath)shapeText).quadTo(44.351444, 145.33565, 43.522392, 146.37524);
((GeneralPath)shapeText).quadTo(42.696632, 147.41486, 41.301723, 147.41486);
((GeneralPath)shapeText).quadTo(40.926678, 147.41486, 40.54176, 147.33919);
((GeneralPath)shapeText).quadTo(40.156845, 147.26352, 39.74232, 147.11548);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(41.72612, 143.99338);
((GeneralPath)shapeText).quadTo(42.397255, 143.99338, 42.78875, 143.53609);
((GeneralPath)shapeText).quadTo(43.180244, 143.0755, 43.180244, 142.27606);
((GeneralPath)shapeText).quadTo(43.180244, 141.4799, 42.78875, 141.01932);
((GeneralPath)shapeText).quadTo(42.397255, 140.55875, 41.72612, 140.55875);
((GeneralPath)shapeText).quadTo(41.05498, 140.55875, 40.6602, 141.01932);
((GeneralPath)shapeText).quadTo(40.2687, 141.4799, 40.2687, 142.27606);
((GeneralPath)shapeText).quadTo(40.2687, 143.0755, 40.6602, 143.53609);
((GeneralPath)shapeText).quadTo(41.05498, 143.99338, 41.72612, 143.99338);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(48.274628, 140.55875);
((GeneralPath)shapeText).quadTo(47.504795, 140.55875, 47.11659, 141.31541);
((GeneralPath)shapeText).quadTo(46.728382, 142.07208, 46.728382, 143.59201);
((GeneralPath)shapeText).quadTo(46.728382, 145.10864, 47.11659, 145.86531);
((GeneralPath)shapeText).quadTo(47.504795, 146.622, 48.274628, 146.622);
((GeneralPath)shapeText).quadTo(49.04775, 146.622, 49.435955, 145.86531);
((GeneralPath)shapeText).quadTo(49.82416, 145.10864, 49.82416, 143.59201);
((GeneralPath)shapeText).quadTo(49.82416, 142.07208, 49.435955, 141.31541);
((GeneralPath)shapeText).quadTo(49.04775, 140.55875, 48.274628, 140.55875);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(48.274628, 139.76917);
((GeneralPath)shapeText).quadTo(49.511623, 139.76917, 50.16631, 140.74956);
((GeneralPath)shapeText).quadTo(50.820995, 141.72665, 50.820995, 143.59201);
((GeneralPath)shapeText).quadTo(50.820995, 145.45409, 50.16631, 146.43446);
((GeneralPath)shapeText).quadTo(49.511623, 147.41486, 48.274628, 147.41486);
((GeneralPath)shapeText).quadTo(47.034344, 147.41486, 46.379654, 146.43446);
((GeneralPath)shapeText).quadTo(45.72826, 145.45409, 45.72826, 143.59201);
((GeneralPath)shapeText).quadTo(45.72826, 141.72665, 46.379654, 140.74956);
((GeneralPath)shapeText).quadTo(47.034344, 139.76917, 48.274628, 139.76917);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(51.983967, 144.09537);
((GeneralPath)shapeText).lineTo(54.64548, 144.09537);
((GeneralPath)shapeText).lineTo(54.64548, 144.90468);
((GeneralPath)shapeText).lineTo(51.983967, 144.90468);
((GeneralPath)shapeText).lineTo(51.983967, 144.09537);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(58.351532, 140.55875);
((GeneralPath)shapeText).quadTo(57.5817, 140.55875, 57.193493, 141.31541);
((GeneralPath)shapeText).quadTo(56.805286, 142.07208, 56.805286, 143.59201);
((GeneralPath)shapeText).quadTo(56.805286, 145.10864, 57.193493, 145.86531);
((GeneralPath)shapeText).quadTo(57.5817, 146.622, 58.351532, 146.622);
((GeneralPath)shapeText).quadTo(59.124653, 146.622, 59.51286, 145.86531);
((GeneralPath)shapeText).quadTo(59.901066, 145.10864, 59.901066, 143.59201);
((GeneralPath)shapeText).quadTo(59.901066, 142.07208, 59.51286, 141.31541);
((GeneralPath)shapeText).quadTo(59.124653, 140.55875, 58.351532, 140.55875);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(58.351532, 139.76917);
((GeneralPath)shapeText).quadTo(59.588528, 139.76917, 60.243214, 140.74956);
((GeneralPath)shapeText).quadTo(60.8979, 141.72665, 60.8979, 143.59201);
((GeneralPath)shapeText).quadTo(60.8979, 145.45409, 60.243214, 146.43446);
((GeneralPath)shapeText).quadTo(59.588528, 147.41486, 58.351532, 147.41486);
((GeneralPath)shapeText).quadTo(57.111248, 147.41486, 56.45656, 146.43446);
((GeneralPath)shapeText).quadTo(55.805164, 145.45409, 55.805164, 143.59201);
((GeneralPath)shapeText).quadTo(55.805164, 141.72665, 56.45656, 140.74956);
((GeneralPath)shapeText).quadTo(57.111248, 139.76917, 58.351532, 139.76917);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(64.7816, 140.55875);
((GeneralPath)shapeText).quadTo(64.01177, 140.55875, 63.623566, 141.31541);
((GeneralPath)shapeText).quadTo(63.23536, 142.07208, 63.23536, 143.59201);
((GeneralPath)shapeText).quadTo(63.23536, 145.10864, 63.623566, 145.86531);
((GeneralPath)shapeText).quadTo(64.01177, 146.622, 64.7816, 146.622);
((GeneralPath)shapeText).quadTo(65.554726, 146.622, 65.94293, 145.86531);
((GeneralPath)shapeText).quadTo(66.33114, 145.10864, 66.33114, 143.59201);
((GeneralPath)shapeText).quadTo(66.33114, 142.07208, 65.94293, 141.31541);
((GeneralPath)shapeText).quadTo(65.554726, 140.55875, 64.7816, 140.55875);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(64.7816, 139.76917);
((GeneralPath)shapeText).quadTo(66.0186, 139.76917, 66.67329, 140.74956);
((GeneralPath)shapeText).quadTo(67.32797, 141.72665, 67.32797, 143.59201);
((GeneralPath)shapeText).quadTo(67.32797, 145.45409, 66.67329, 146.43446);
((GeneralPath)shapeText).quadTo(66.0186, 147.41486, 64.7816, 147.41486);
((GeneralPath)shapeText).quadTo(63.54132, 147.41486, 62.88663, 146.43446);
((GeneralPath)shapeText).quadTo(62.235237, 145.45409, 62.235237, 143.59201);
((GeneralPath)shapeText).quadTo(62.235237, 141.72665, 62.88663, 140.74956);
((GeneralPath)shapeText).quadTo(63.54132, 139.76917, 64.7816, 139.76917);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(71.21168, 140.55875);
((GeneralPath)shapeText).quadTo(70.44185, 140.55875, 70.05364, 141.31541);
((GeneralPath)shapeText).quadTo(69.665436, 142.07208, 69.665436, 143.59201);
((GeneralPath)shapeText).quadTo(69.665436, 145.10864, 70.05364, 145.86531);
((GeneralPath)shapeText).quadTo(70.44185, 146.622, 71.21168, 146.622);
((GeneralPath)shapeText).quadTo(71.9848, 146.622, 72.37301, 145.86531);
((GeneralPath)shapeText).quadTo(72.761215, 145.10864, 72.761215, 143.59201);
((GeneralPath)shapeText).quadTo(72.761215, 142.07208, 72.37301, 141.31541);
((GeneralPath)shapeText).quadTo(71.9848, 140.55875, 71.21168, 140.55875);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(71.21168, 139.76917);
((GeneralPath)shapeText).quadTo(72.44868, 139.76917, 73.10336, 140.74956);
((GeneralPath)shapeText).quadTo(73.75805, 141.72665, 73.75805, 143.59201);
((GeneralPath)shapeText).quadTo(73.75805, 145.45409, 73.10336, 146.43446);
((GeneralPath)shapeText).quadTo(72.44868, 147.41486, 71.21168, 147.41486);
((GeneralPath)shapeText).quadTo(69.9714, 147.41486, 69.31671, 146.43446);
((GeneralPath)shapeText).quadTo(68.66531, 145.45409, 68.66531, 143.59201);
((GeneralPath)shapeText).quadTo(68.66531, 141.72665, 69.31671, 140.74956);
((GeneralPath)shapeText).quadTo(69.9714, 139.76917, 71.21168, 139.76917);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(75.53951, 147.11548);
((GeneralPath)shapeText).lineTo(75.53951, 146.20746);
((GeneralPath)shapeText).quadTo(75.91456, 146.38512, 76.29948, 146.48053);
((GeneralPath)shapeText).quadTo(76.684395, 146.57265, 77.052864, 146.57265);
((GeneralPath)shapeText).quadTo(78.039825, 146.57265, 78.55962, 145.91138);
((GeneralPath)shapeText).quadTo(79.08272, 145.24683, 79.1551, 143.89468);
((GeneralPath)shapeText).quadTo(78.86887, 144.31908, 78.42803, 144.54608);
((GeneralPath)shapeText).quadTo(77.99048, 144.77307, 77.45752, 144.77307);
((GeneralPath)shapeText).quadTo(76.35212, 144.77307, 75.7073, 144.10522);
((GeneralPath)shapeText).quadTo(75.06577, 143.4341, 75.06577, 142.27606);
((GeneralPath)shapeText).quadTo(75.06577, 141.14105, 75.73691, 140.45676);
((GeneralPath)shapeText).quadTo(76.40804, 139.76917, 77.523315, 139.76917);
((GeneralPath)shapeText).quadTo(78.79979, 139.76917, 79.47421, 140.74956);
((GeneralPath)shapeText).quadTo(80.148636, 141.72665, 80.148636, 143.59201);
((GeneralPath)shapeText).quadTo(80.148636, 145.33565, 79.31959, 146.37524);
((GeneralPath)shapeText).quadTo(78.49383, 147.41486, 77.09892, 147.41486);
((GeneralPath)shapeText).quadTo(76.72387, 147.41486, 76.33896, 147.33919);
((GeneralPath)shapeText).quadTo(75.95404, 147.26352, 75.53951, 147.11548);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(77.523315, 143.99338);
((GeneralPath)shapeText).quadTo(78.19445, 143.99338, 78.585945, 143.53609);
((GeneralPath)shapeText).quadTo(78.97744, 143.0755, 78.97744, 142.27606);
((GeneralPath)shapeText).quadTo(78.97744, 141.4799, 78.585945, 141.01932);
((GeneralPath)shapeText).quadTo(78.19445, 140.55875, 77.523315, 140.55875);
((GeneralPath)shapeText).quadTo(76.85218, 140.55875, 76.45739, 141.01932);
((GeneralPath)shapeText).quadTo(76.065895, 141.4799, 76.065895, 142.27606);
((GeneralPath)shapeText).quadTo(76.065895, 143.0755, 76.45739, 143.53609);
((GeneralPath)shapeText).quadTo(76.85218, 143.99338, 77.523315, 143.99338);
((GeneralPath)shapeText).closePath();
