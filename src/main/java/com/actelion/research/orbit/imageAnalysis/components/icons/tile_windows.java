 ...
 */
public class tile_windows implements ResizableIcon {
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIcon of(int width, int height) {
       tile_windows base = new tile_windows();
       base.width = width;
       base.height = height;
       return base;
    }
