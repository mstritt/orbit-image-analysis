 ...
 */
public class DrawRoi2 implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.setTransform(transformations.poll()); // _0_0_1_11
        transformations.offer(g.getTransform());
        ...
        g.setTransform(transformations.poll()); // _0_0_1_12
        transformations.offer(g.getTransform());
        ...
        g.setTransform(transformations.poll()); // _0_0_1_13
        ...
        g.setTransform(transformations.poll()); // _0_0_1_19
        transformations.offer(g.getTransform());
        ...
        g.setTransform(transformations.poll()); // _0_0_1_20
