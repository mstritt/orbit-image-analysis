...
public class DLR101SegmentationSettings extends AbstractSegmentationSettings<DLR101SegmentationSettings> implements Serializable, Cloneable {
    ...
    public DLR101SegmentationSettings(String modelName, String remoteModelURL, String modelPath, int imageWidth, int imageHeight, float tileScaleFactor, String annotationPrefix, boolean segmentationRefinement) {
    ...
    public DLR101SegmentationSettings(String modelName, String remoteModelURL, String modelPath, int imageWidth, int imageHeight,
