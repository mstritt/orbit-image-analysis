...
((GeneralPath)shapeText).lineTo(26.16824, 137.62706);
((GeneralPath)shapeText).lineTo(21.429186, 137.62706);
((GeneralPath)shapeText).lineTo(21.429186, 140.35213);
((GeneralPath)shapeText).lineTo(25.968119, 140.35213);
((GeneralPath)shapeText).lineTo(25.968119, 141.44214);
((GeneralPath)shapeText).lineTo(21.429186, 141.44214);
((GeneralPath)shapeText).lineTo(21.429186, 144.98473);
((GeneralPath)shapeText).lineTo(26.283203, 144.98473);
...
((GeneralPath)shapeText).lineTo(29.69379, 144.98473);
((GeneralPath)shapeText).lineTo(34.33491, 144.98473);
...
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(36.9812, 141.44214);
((GeneralPath)shapeText).lineTo(36.9812, 145.01027);
((GeneralPath)shapeText).lineTo(39.05055, 145.01027);
((GeneralPath)shapeText).quadTo(40.089478, 145.01027, 40.59191, 144.57172);
((GeneralPath)shapeText).quadTo(41.094345, 144.13315, 41.094345, 143.22195);
((GeneralPath)shapeText).quadTo(41.094345, 142.3065, 40.59191, 141.87645);
((GeneralPath)shapeText).quadTo(40.089478, 141.44214, 39.05055, 141.44214);
((GeneralPath)shapeText).lineTo(36.9812, 141.44214);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(36.9812, 137.60152);
((GeneralPath)shapeText).lineTo(36.9812, 140.39044);
((GeneralPath)shapeText).lineTo(38.88875, 140.39044);
((GeneralPath)shapeText).quadTo(39.834003, 140.39044, 40.298115, 140.0498);
((GeneralPath)shapeText).quadTo(40.762226, 139.70493, 40.762226, 138.99385);
((GeneralPath)shapeText).quadTo(40.762226, 138.29555, 40.298115, 137.95065);
((GeneralPath)shapeText).quadTo(39.834003, 137.60152, 38.88875, 137.60152);
((GeneralPath)shapeText).lineTo(36.9812, 137.60152);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(35.691055, 136.53703);
((GeneralPath)shapeText).lineTo(38.98668, 136.53703);
((GeneralPath)shapeText).quadTo(40.459915, 136.53703, 41.256145, 137.14166);
((GeneralPath)shapeText).quadTo(42.056633, 137.74202, 42.056633, 138.84908);
((GeneralPath)shapeText).quadTo(42.056633, 139.70493, 41.647873, 140.21587);
((GeneralPath)shapeText).quadTo(41.239113, 140.72256, 40.447144, 140.8503);
((GeneralPath)shapeText).quadTo(41.400913, 141.05893, 41.924637, 141.71892);
((GeneralPath)shapeText).quadTo(42.452618, 142.37463, 42.452618, 143.3582);
((GeneralPath)shapeText).quadTo(42.452618, 144.66113, 41.584003, 145.36794);
...
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(47.538692, 137.42694);
((GeneralPath)shapeText).quadTo(46.542343, 137.42694, 46.03991, 138.39774);
((GeneralPath)shapeText).quadTo(45.537476, 139.36429, 45.537476, 141.3059);
((GeneralPath)shapeText).quadTo(45.537476, 143.24324, 46.03991, 144.21405);
((GeneralPath)shapeText).quadTo(46.542343, 145.18484, 47.538692, 145.18484);
((GeneralPath)shapeText).quadTo(48.539303, 145.18484, 49.041737, 144.21405);
((GeneralPath)shapeText).quadTo(49.54417, 143.24324, 49.54417, 141.3059);
((GeneralPath)shapeText).quadTo(49.54417, 139.36429, 49.041737, 138.39774);
((GeneralPath)shapeText).quadTo(48.539303, 137.42694, 47.538692, 137.42694);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(47.538692, 136.40079);
((GeneralPath)shapeText).quadTo(49.139668, 136.40079, 49.98699, 137.66112);
((GeneralPath)shapeText).quadTo(50.834316, 138.9172, 50.834316, 141.31015);
((GeneralPath)shapeText).quadTo(50.834316, 143.69458, 49.98699, 144.95493);
((GeneralPath)shapeText).quadTo(49.139668, 146.211, 47.538692, 146.211);
((GeneralPath)shapeText).quadTo(45.93346, 146.211, 45.086136, 144.95493);
((GeneralPath)shapeText).quadTo(44.243073, 143.69458, 44.243073, 141.31015);
((GeneralPath)shapeText).quadTo(44.243073, 138.9172, 45.086136, 137.66112);
((GeneralPath)shapeText).quadTo(45.93346, 136.40079, 47.538692, 136.40079);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(55.86078, 137.42694);
((GeneralPath)shapeText).quadTo(54.86443, 137.42694, 54.361996, 138.39774);
((GeneralPath)shapeText).quadTo(53.859562, 139.36429, 53.859562, 141.3059);
((GeneralPath)shapeText).quadTo(53.859562, 143.24324, 54.361996, 144.21405);
((GeneralPath)shapeText).quadTo(54.86443, 145.18484, 55.86078, 145.18484);
((GeneralPath)shapeText).quadTo(56.86139, 145.18484, 57.363823, 144.21405);
((GeneralPath)shapeText).quadTo(57.866257, 143.24324, 57.866257, 141.3059);
((GeneralPath)shapeText).quadTo(57.866257, 139.36429, 57.363823, 138.39774);
((GeneralPath)shapeText).quadTo(56.86139, 137.42694, 55.86078, 137.42694);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(55.86078, 136.40079);
((GeneralPath)shapeText).quadTo(57.461754, 136.40079, 58.30908, 137.66112);
((GeneralPath)shapeText).quadTo(59.156403, 138.9172, 59.156403, 141.31015);
((GeneralPath)shapeText).quadTo(59.156403, 143.69458, 58.30908, 144.95493);
((GeneralPath)shapeText).quadTo(57.461754, 146.211, 55.86078, 146.211);
((GeneralPath)shapeText).quadTo(54.255547, 146.211, 53.408222, 144.95493);
((GeneralPath)shapeText).quadTo(52.56516, 143.69458, 52.56516, 141.31015);
((GeneralPath)shapeText).quadTo(52.56516, 138.9172, 53.408222, 137.66112);
((GeneralPath)shapeText).quadTo(54.255547, 136.40079, 55.86078, 136.40079);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(61.462063, 145.82779);
((GeneralPath)shapeText).lineTo(61.462063, 144.6526);
((GeneralPath)shapeText).quadTo(61.947464, 144.87828, 62.44564, 145.00175);
((GeneralPath)shapeText).quadTo(62.943813, 145.12099, 63.4207, 145.12099);
((GeneralPath)shapeText).quadTo(64.698074, 145.12099, 65.37083, 144.26514);
((GeneralPath)shapeText).quadTo(66.04783, 143.40504, 66.1415, 141.66782);
((GeneralPath)shapeText).quadTo(65.771065, 142.21709, 65.20051, 142.51088);
((GeneralPath)shapeText).quadTo(64.63421, 142.80467, 63.944424, 142.80467);
((GeneralPath)shapeText).quadTo(62.513767, 142.80467, 61.679214, 141.94884);
((GeneralPath)shapeText).quadTo(60.848923, 141.093, 60.848923, 139.60698);
((GeneralPath)shapeText).quadTo(60.848923, 138.15504, 61.717537, 137.27791);
((GeneralPath)shapeText).quadTo(62.58615, 136.40079, 64.02958, 136.40079);
((GeneralPath)shapeText).quadTo(65.68165, 136.40079, 66.55452, 137.66112);
((GeneralPath)shapeText).quadTo(67.42739, 138.9172, 67.42739, 141.31015);
((GeneralPath)shapeText).quadTo(67.42739, 143.54555, 66.3544, 144.87828);
((GeneralPath)shapeText).quadTo(65.28567, 146.211, 63.480312, 146.211);
((GeneralPath)shapeText).quadTo(62.99491, 146.211, 62.496735, 146.11307);
((GeneralPath)shapeText).quadTo(61.998558, 146.0194, 61.462063, 145.82779);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(64.02958, 141.79129);
((GeneralPath)shapeText).quadTo(64.89819, 141.79129, 65.404884, 141.20796);
((GeneralPath)shapeText).quadTo(65.911575, 140.62463, 65.911575, 139.60698);
((GeneralPath)shapeText).quadTo(65.911575, 138.59785, 65.404884, 138.01453);
((GeneralPath)shapeText).quadTo(64.89819, 137.42694, 64.02958, 137.42694);
((GeneralPath)shapeText).quadTo(63.16097, 137.42694, 62.65002, 138.01453);
((GeneralPath)shapeText).quadTo(62.143326, 138.59785, 62.143326, 139.60698);
((GeneralPath)shapeText).quadTo(62.143326, 140.62463, 62.65002, 141.20796);
((GeneralPath)shapeText).quadTo(63.16097, 141.79129, 64.02958, 141.79129);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(72.50495, 137.42694);
((GeneralPath)shapeText).quadTo(71.5086, 137.42694, 71.006165, 138.39774);
((GeneralPath)shapeText).quadTo(70.50373, 139.36429, 70.50373, 141.3059);
((GeneralPath)shapeText).quadTo(70.50373, 143.24324, 71.006165, 144.21405);
((GeneralPath)shapeText).quadTo(71.5086, 145.18484, 72.50495, 145.18484);
((GeneralPath)shapeText).quadTo(73.50556, 145.18484, 74.00799, 144.21405);
((GeneralPath)shapeText).quadTo(74.51042, 143.24324, 74.51042, 141.3059);
((GeneralPath)shapeText).quadTo(74.51042, 139.36429, 74.00799, 138.39774);
((GeneralPath)shapeText).quadTo(73.50556, 137.42694, 72.50495, 137.42694);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(72.50495, 136.40079);
((GeneralPath)shapeText).quadTo(74.10593, 136.40079, 74.95325, 137.66112);
((GeneralPath)shapeText).quadTo(75.800575, 138.9172, 75.800575, 141.31015);
((GeneralPath)shapeText).quadTo(75.800575, 143.69458, 74.95325, 144.95493);
((GeneralPath)shapeText).quadTo(74.10593, 146.211, 72.50495, 146.211);
((GeneralPath)shapeText).quadTo(70.89972, 146.211, 70.05239, 144.95493);
((GeneralPath)shapeText).quadTo(69.20933, 143.69458, 69.20933, 141.31015);
((GeneralPath)shapeText).quadTo(69.20933, 138.9172, 70.05239, 137.66112);
((GeneralPath)shapeText).quadTo(70.89972, 136.40079, 72.50495, 136.40079);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(77.30575, 142.02548);
((GeneralPath)shapeText).lineTo(80.7504, 142.02548);
((GeneralPath)shapeText).lineTo(80.7504, 143.07718);
((GeneralPath)shapeText).lineTo(77.30575, 143.07718);
((GeneralPath)shapeText).lineTo(77.30575, 142.02548);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(85.546936, 137.42694);
((GeneralPath)shapeText).quadTo(84.55058, 137.42694, 84.04815, 138.39774);
((GeneralPath)shapeText).quadTo(83.545715, 139.36429, 83.545715, 141.3059);
((GeneralPath)shapeText).quadTo(83.545715, 143.24324, 84.04815, 144.21405);
((GeneralPath)shapeText).quadTo(84.55058, 145.18484, 85.546936, 145.18484);
((GeneralPath)shapeText).quadTo(86.54755, 145.18484, 87.04997, 144.21405);
((GeneralPath)shapeText).quadTo(87.55241, 143.24324, 87.55241, 141.3059);
((GeneralPath)shapeText).quadTo(87.55241, 139.36429, 87.04997, 138.39774);
((GeneralPath)shapeText).quadTo(86.54755, 137.42694, 85.546936, 137.42694);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(85.546936, 136.40079);
((GeneralPath)shapeText).quadTo(87.14791, 136.40079, 87.99523, 137.66112);
((GeneralPath)shapeText).quadTo(88.84256, 138.9172, 88.84256, 141.31015);
((GeneralPath)shapeText).quadTo(88.84256, 143.69458, 87.99523, 144.95493);
((GeneralPath)shapeText).quadTo(87.14791, 146.211, 85.546936, 146.211);
((GeneralPath)shapeText).quadTo(83.9417, 146.211, 83.094376, 144.95493);
((GeneralPath)shapeText).quadTo(82.25131, 143.69458, 82.25131, 141.31015);
((GeneralPath)shapeText).quadTo(82.25131, 138.9172, 83.094376, 137.66112);
((GeneralPath)shapeText).quadTo(83.9417, 136.40079, 85.546936, 136.40079);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(93.869026, 137.42694);
((GeneralPath)shapeText).quadTo(92.87267, 137.42694, 92.37024, 138.39774);
((GeneralPath)shapeText).quadTo(91.867805, 139.36429, 91.867805, 141.3059);
((GeneralPath)shapeText).quadTo(91.867805, 143.24324, 92.37024, 144.21405);
((GeneralPath)shapeText).quadTo(92.87267, 145.18484, 93.869026, 145.18484);
((GeneralPath)shapeText).quadTo(94.86964, 145.18484, 95.37206, 144.21405);
((GeneralPath)shapeText).quadTo(95.8745, 143.24324, 95.8745, 141.3059);
((GeneralPath)shapeText).quadTo(95.8745, 139.36429, 95.37206, 138.39774);
((GeneralPath)shapeText).quadTo(94.86964, 137.42694, 93.869026, 137.42694);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(93.869026, 136.40079);
((GeneralPath)shapeText).quadTo(95.47, 136.40079, 96.31732, 137.66112);
((GeneralPath)shapeText).quadTo(97.16465, 138.9172, 97.16465, 141.31015);
((GeneralPath)shapeText).quadTo(97.16465, 143.69458, 96.31732, 144.95493);
((GeneralPath)shapeText).quadTo(95.47, 146.211, 93.869026, 146.211);
((GeneralPath)shapeText).quadTo(92.263794, 146.211, 91.416466, 144.95493);
((GeneralPath)shapeText).quadTo(90.5734, 143.69458, 90.5734, 141.31015);
((GeneralPath)shapeText).quadTo(90.5734, 138.9172, 91.416466, 137.66112);
((GeneralPath)shapeText).quadTo(92.263794, 136.40079, 93.869026, 136.40079);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(102.19111, 137.42694);
((GeneralPath)shapeText).quadTo(101.194756, 137.42694, 100.69232, 138.39774);
((GeneralPath)shapeText).quadTo(100.18989, 139.36429, 100.18989, 141.3059);
((GeneralPath)shapeText).quadTo(100.18989, 143.24324, 100.69232, 144.21405);
((GeneralPath)shapeText).quadTo(101.194756, 145.18484, 102.19111, 145.18484);
((GeneralPath)shapeText).quadTo(103.19172, 145.18484, 103.694145, 144.21405);
((GeneralPath)shapeText).quadTo(104.19658, 143.24324, 104.19658, 141.3059);
((GeneralPath)shapeText).quadTo(104.19658, 139.36429, 103.694145, 138.39774);
((GeneralPath)shapeText).quadTo(103.19172, 137.42694, 102.19111, 137.42694);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(102.19111, 136.40079);
((GeneralPath)shapeText).quadTo(103.79208, 136.40079, 104.639404, 137.66112);
((GeneralPath)shapeText).quadTo(105.48673, 138.9172, 105.48673, 141.31015);
((GeneralPath)shapeText).quadTo(105.48673, 143.69458, 104.639404, 144.95493);
((GeneralPath)shapeText).quadTo(103.79208, 146.211, 102.19111, 146.211);
((GeneralPath)shapeText).quadTo(100.58588, 146.211, 99.73855, 144.95493);
((GeneralPath)shapeText).quadTo(98.895485, 143.69458, 98.895485, 141.31015);
((GeneralPath)shapeText).quadTo(98.895485, 138.9172, 99.73855, 137.66112);
((GeneralPath)shapeText).quadTo(100.58588, 136.40079, 102.19111, 136.40079);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(107.79238, 145.82779);
((GeneralPath)shapeText).lineTo(107.79238, 144.6526);
((GeneralPath)shapeText).quadTo(108.27779, 144.87828, 108.77596, 145.00175);
((GeneralPath)shapeText).quadTo(109.27414, 145.12099, 109.75102, 145.12099);
((GeneralPath)shapeText).quadTo(111.0284, 145.12099, 111.70115, 144.26514);
((GeneralPath)shapeText).quadTo(112.37815, 143.40504, 112.471825, 141.66782);
((GeneralPath)shapeText).quadTo(112.10139, 142.21709, 111.53083, 142.51088);
((GeneralPath)shapeText).quadTo(110.96453, 142.80467, 110.27475, 142.80467);
((GeneralPath)shapeText).quadTo(108.844086, 142.80467, 108.00954, 141.94884);
((GeneralPath)shapeText).quadTo(107.179245, 141.093, 107.179245, 139.60698);
((GeneralPath)shapeText).quadTo(107.179245, 138.15504, 108.04786, 137.27791);
((GeneralPath)shapeText).quadTo(108.91647, 136.40079, 110.3599, 136.40079);
((GeneralPath)shapeText).quadTo(112.01197, 136.40079, 112.88484, 137.66112);
((GeneralPath)shapeText).quadTo(113.75771, 138.9172, 113.75771, 141.31015);
((GeneralPath)shapeText).quadTo(113.75771, 143.54555, 112.68472, 144.87828);
((GeneralPath)shapeText).quadTo(111.61599, 146.211, 109.81063, 146.211);
((GeneralPath)shapeText).quadTo(109.32523, 146.211, 108.82706, 146.11307);
((GeneralPath)shapeText).quadTo(108.32888, 146.0194, 107.79238, 145.82779);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(110.3599, 141.79129);
((GeneralPath)shapeText).quadTo(111.228516, 141.79129, 111.73521, 141.20796);
((GeneralPath)shapeText).quadTo(112.2419, 140.62463, 112.2419, 139.60698);
((GeneralPath)shapeText).quadTo(112.2419, 138.59785, 111.73521, 138.01453);
((GeneralPath)shapeText).quadTo(111.228516, 137.42694, 110.3599, 137.42694);
((GeneralPath)shapeText).quadTo(109.49129, 137.42694, 108.98034, 138.01453);
((GeneralPath)shapeText).quadTo(108.47365, 138.59785, 108.47365, 139.60698);
((GeneralPath)shapeText).quadTo(108.47365, 140.62463, 108.98034, 141.20796);
((GeneralPath)shapeText).quadTo(109.49129, 141.79129, 110.3599, 141.79129);
((GeneralPath)shapeText).closePath();
