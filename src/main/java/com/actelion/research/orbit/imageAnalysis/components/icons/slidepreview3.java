...
((GeneralPath)shapeText).lineTo(49.49106, 140.74297);
((GeneralPath)shapeText).lineTo(45.829422, 140.74297);
((GeneralPath)shapeText).lineTo(45.829422, 142.8485);
((GeneralPath)shapeText).lineTo(49.336433, 142.8485);
((GeneralPath)shapeText).lineTo(49.336433, 143.6907);
((GeneralPath)shapeText).lineTo(45.829422, 143.6907);
((GeneralPath)shapeText).lineTo(45.829422, 146.42789);
((GeneralPath)shapeText).lineTo(49.579884, 146.42789);
...
((GeneralPath)shapeText).lineTo(52.21508, 146.42789);
((GeneralPath)shapeText).lineTo(55.80105, 146.42789);
...
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(57.84571, 143.6907);
((GeneralPath)shapeText).lineTo(57.84571, 146.44763);
((GeneralPath)shapeText).lineTo(59.44459, 146.44763);
((GeneralPath)shapeText).quadTo(60.247322, 146.44763, 60.63553, 146.10876);
((GeneralPath)shapeText).quadTo(61.023735, 145.76991, 61.023735, 145.06587);
((GeneralPath)shapeText).quadTo(61.023735, 144.35855, 60.63553, 144.02628);
((GeneralPath)shapeText).quadTo(60.247322, 143.6907, 59.44459, 143.6907);
((GeneralPath)shapeText).lineTo(57.84571, 143.6907);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(57.84571, 140.72324);
((GeneralPath)shapeText).lineTo(57.84571, 142.8781);
((GeneralPath)shapeText).lineTo(59.319576, 142.8781);
((GeneralPath)shapeText).quadTo(60.04993, 142.8781, 60.408527, 142.61491);
((GeneralPath)shapeText).quadTo(60.767124, 142.34843, 60.767124, 141.79903);
((GeneralPath)shapeText).quadTo(60.767124, 141.25949, 60.408527, 140.993);
((GeneralPath)shapeText).quadTo(60.04993, 140.72324, 59.319576, 140.72324);
((GeneralPath)shapeText).lineTo(57.84571, 140.72324);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(56.848877, 139.90076);
((GeneralPath)shapeText).lineTo(59.395245, 139.90076);
((GeneralPath)shapeText).quadTo(60.533543, 139.90076, 61.14875, 140.36792);
((GeneralPath)shapeText).quadTo(61.767246, 140.8318, 61.767246, 141.68716);
((GeneralPath)shapeText).quadTo(61.767246, 142.34843, 61.45142, 142.74323);
((GeneralPath)shapeText).quadTo(61.13559, 143.13472, 60.523674, 143.23341);
((GeneralPath)shapeText).quadTo(61.260605, 143.39462, 61.66526, 143.90454);
((GeneralPath)shapeText).quadTo(62.073208, 144.4112, 62.073208, 145.17116);
((GeneralPath)shapeText).quadTo(62.073208, 146.17786, 61.40207, 146.72397);
...
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(66.00297, 140.58835);
((GeneralPath)shapeText).quadTo(65.23314, 140.58835, 64.84493, 141.33844);
((GeneralPath)shapeText).quadTo(64.456726, 142.08525, 64.456726, 143.58543);
((GeneralPath)shapeText).quadTo(64.456726, 145.08232, 64.84493, 145.83241);
((GeneralPath)shapeText).quadTo(65.23314, 146.5825, 66.00297, 146.5825);
((GeneralPath)shapeText).quadTo(66.77609, 146.5825, 67.1643, 145.83241);
((GeneralPath)shapeText).quadTo(67.552505, 145.08232, 67.552505, 143.58543);
((GeneralPath)shapeText).quadTo(67.552505, 142.08525, 67.1643, 141.33844);
((GeneralPath)shapeText).quadTo(66.77609, 140.58835, 66.00297, 140.58835);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(66.00297, 139.79549);
((GeneralPath)shapeText).quadTo(67.23997, 139.79549, 67.89465, 140.76929);
((GeneralPath)shapeText).quadTo(68.54934, 141.7398, 68.54934, 143.58871);
((GeneralPath)shapeText).quadTo(68.54934, 145.43105, 67.89465, 146.40486);
((GeneralPath)shapeText).quadTo(67.23997, 147.37537, 66.00297, 147.37537);
((GeneralPath)shapeText).quadTo(64.76269, 147.37537, 64.108, 146.40486);
((GeneralPath)shapeText).quadTo(63.456604, 145.43105, 63.456604, 143.58871);
((GeneralPath)shapeText).quadTo(63.456604, 141.7398, 64.108, 140.76929);
((GeneralPath)shapeText).quadTo(64.76269, 139.79549, 66.00297, 139.79549);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(72.43304, 140.58835);
((GeneralPath)shapeText).quadTo(71.66321, 140.58835, 71.275, 141.33844);
((GeneralPath)shapeText).quadTo(70.886795, 142.08525, 70.886795, 143.58543);
((GeneralPath)shapeText).quadTo(70.886795, 145.08232, 71.275, 145.83241);
((GeneralPath)shapeText).quadTo(71.66321, 146.5825, 72.43304, 146.5825);
((GeneralPath)shapeText).quadTo(73.20616, 146.5825, 73.59437, 145.83241);
((GeneralPath)shapeText).quadTo(73.982574, 145.08232, 73.982574, 143.58543);
((GeneralPath)shapeText).quadTo(73.982574, 142.08525, 73.59437, 141.33844);
((GeneralPath)shapeText).quadTo(73.20616, 140.58835, 72.43304, 140.58835);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(72.43304, 139.79549);
((GeneralPath)shapeText).quadTo(73.67004, 139.79549, 74.32472, 140.76929);
((GeneralPath)shapeText).quadTo(74.97941, 141.7398, 74.97941, 143.58871);
((GeneralPath)shapeText).quadTo(74.97941, 145.43105, 74.32472, 146.40486);
((GeneralPath)shapeText).quadTo(73.67004, 147.37537, 72.43304, 147.37537);
((GeneralPath)shapeText).quadTo(71.19276, 147.37537, 70.53807, 146.40486);
((GeneralPath)shapeText).quadTo(69.88667, 145.43105, 69.88667, 143.58871);
((GeneralPath)shapeText).quadTo(69.88667, 141.7398, 70.53807, 140.76929);
((GeneralPath)shapeText).quadTo(71.19276, 139.79549, 72.43304, 139.79549);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(76.76088, 147.07928);
((GeneralPath)shapeText).lineTo(76.76088, 146.17128);
((GeneralPath)shapeText).quadTo(77.135925, 146.34564, 77.52084, 146.44104);
((GeneralPath)shapeText).quadTo(77.90576, 146.53316, 78.27423, 146.53316);
((GeneralPath)shapeText).quadTo(79.26119, 146.53316, 79.78099, 145.8719);
((GeneralPath)shapeText).quadTo(80.304085, 145.20734, 80.376465, 143.86507);
((GeneralPath)shapeText).quadTo(80.09024, 144.28946, 79.6494, 144.51646);
((GeneralPath)shapeText).quadTo(79.211845, 144.74347, 78.67889, 144.74347);
((GeneralPath)shapeText).quadTo(77.57349, 144.74347, 76.928665, 144.0822);
((GeneralPath)shapeText).quadTo(76.28714, 143.42093, 76.28714, 142.27277);
((GeneralPath)shapeText).quadTo(76.28714, 141.15092, 76.958275, 140.4732);
((GeneralPath)shapeText).quadTo(77.62941, 139.79549, 78.74468, 139.79549);
((GeneralPath)shapeText).quadTo(80.02116, 139.79549, 80.69558, 140.76929);
((GeneralPath)shapeText).quadTo(81.37, 141.7398, 81.37, 143.58871);
((GeneralPath)shapeText).quadTo(81.37, 145.3159, 80.540955, 146.34564);
((GeneralPath)shapeText).quadTo(79.715195, 147.37537, 78.32029, 147.37537);
((GeneralPath)shapeText).quadTo(77.94524, 147.37537, 77.560326, 147.2997);
((GeneralPath)shapeText).quadTo(77.17541, 147.22733, 76.76088, 147.07928);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(78.74468, 143.96048);
((GeneralPath)shapeText).quadTo(79.41582, 143.96048, 79.80731, 143.50977);
((GeneralPath)shapeText).quadTo(80.19881, 143.05905, 80.19881, 142.27277);
((GeneralPath)shapeText).quadTo(80.19881, 141.49307, 79.80731, 141.04236);
((GeneralPath)shapeText).quadTo(79.41582, 140.58835, 78.74468, 140.58835);
((GeneralPath)shapeText).quadTo(78.07355, 140.58835, 77.67876, 141.04236);
((GeneralPath)shapeText).quadTo(77.28726, 141.49307, 77.28726, 142.27277);
((GeneralPath)shapeText).quadTo(77.28726, 143.05905, 77.67876, 143.50977);
((GeneralPath)shapeText).quadTo(78.07355, 143.96048, 78.74468, 143.96048);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(85.29319, 140.58835);
((GeneralPath)shapeText).quadTo(84.52336, 140.58835, 84.135155, 141.33844);
((GeneralPath)shapeText).quadTo(83.74695, 142.08525, 83.74695, 143.58543);
((GeneralPath)shapeText).quadTo(83.74695, 145.08232, 84.135155, 145.83241);
((GeneralPath)shapeText).quadTo(84.52336, 146.5825, 85.29319, 146.5825);
((GeneralPath)shapeText).quadTo(86.066315, 146.5825, 86.45452, 145.83241);
((GeneralPath)shapeText).quadTo(86.84273, 145.08232, 86.84273, 143.58543);
((GeneralPath)shapeText).quadTo(86.84273, 142.08525, 86.45452, 141.33844);
((GeneralPath)shapeText).quadTo(86.066315, 140.58835, 85.29319, 140.58835);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(85.29319, 139.79549);
((GeneralPath)shapeText).quadTo(86.53019, 139.79549, 87.184875, 140.76929);
((GeneralPath)shapeText).quadTo(87.83956, 141.7398, 87.83956, 143.58871);
((GeneralPath)shapeText).quadTo(87.83956, 145.43105, 87.184875, 146.40486);
((GeneralPath)shapeText).quadTo(86.53019, 147.37537, 85.29319, 147.37537);
((GeneralPath)shapeText).quadTo(84.05291, 147.37537, 83.398224, 146.40486);
((GeneralPath)shapeText).quadTo(82.746826, 145.43105, 82.746826, 143.58871);
((GeneralPath)shapeText).quadTo(82.746826, 141.7398, 83.398224, 140.76929);
((GeneralPath)shapeText).quadTo(84.05291, 139.79549, 85.29319, 139.79549);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(89.00253, 144.14142);
((GeneralPath)shapeText).lineTo(91.66405, 144.14142);
((GeneralPath)shapeText).lineTo(91.66405, 144.95403);
((GeneralPath)shapeText).lineTo(89.00253, 144.95403);
((GeneralPath)shapeText).lineTo(89.00253, 144.14142);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(95.370094, 140.58835);
((GeneralPath)shapeText).quadTo(94.600266, 140.58835, 94.21206, 141.33844);
((GeneralPath)shapeText).quadTo(93.82385, 142.08525, 93.82385, 143.58543);
((GeneralPath)shapeText).quadTo(93.82385, 145.08232, 94.21206, 145.83241);
((GeneralPath)shapeText).quadTo(94.600266, 146.5825, 95.370094, 146.5825);
((GeneralPath)shapeText).quadTo(96.14322, 146.5825, 96.531425, 145.83241);
((GeneralPath)shapeText).quadTo(96.91963, 145.08232, 96.91963, 143.58543);
((GeneralPath)shapeText).quadTo(96.91963, 142.08525, 96.531425, 141.33844);
((GeneralPath)shapeText).quadTo(96.14322, 140.58835, 95.370094, 140.58835);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(95.370094, 139.79549);
((GeneralPath)shapeText).quadTo(96.60709, 139.79549, 97.26178, 140.76929);
((GeneralPath)shapeText).quadTo(97.916466, 141.7398, 97.916466, 143.58871);
((GeneralPath)shapeText).quadTo(97.916466, 145.43105, 97.26178, 146.40486);
((GeneralPath)shapeText).quadTo(96.60709, 147.37537, 95.370094, 147.37537);
((GeneralPath)shapeText).quadTo(94.129814, 147.37537, 93.47513, 146.40486);
((GeneralPath)shapeText).quadTo(92.82373, 145.43105, 92.82373, 143.58871);
((GeneralPath)shapeText).quadTo(92.82373, 141.7398, 93.47513, 140.76929);
((GeneralPath)shapeText).quadTo(94.129814, 139.79549, 95.370094, 139.79549);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(101.80016, 140.58835);
((GeneralPath)shapeText).quadTo(101.030334, 140.58835, 100.64213, 141.33844);
((GeneralPath)shapeText).quadTo(100.25392, 142.08525, 100.25392, 143.58543);
((GeneralPath)shapeText).quadTo(100.25392, 145.08232, 100.64213, 145.83241);
((GeneralPath)shapeText).quadTo(101.030334, 146.5825, 101.80016, 146.5825);
((GeneralPath)shapeText).quadTo(102.57329, 146.5825, 102.961494, 145.83241);
((GeneralPath)shapeText).quadTo(103.3497, 145.08232, 103.3497, 143.58543);
((GeneralPath)shapeText).quadTo(103.3497, 142.08525, 102.961494, 141.33844);
((GeneralPath)shapeText).quadTo(102.57329, 140.58835, 101.80016, 140.58835);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(101.80016, 139.79549);
((GeneralPath)shapeText).quadTo(103.03716, 139.79549, 103.69185, 140.76929);
((GeneralPath)shapeText).quadTo(104.346535, 141.7398, 104.346535, 143.58871);
((GeneralPath)shapeText).quadTo(104.346535, 145.43105, 103.69185, 146.40486);
((GeneralPath)shapeText).quadTo(103.03716, 147.37537, 101.80016, 147.37537);
((GeneralPath)shapeText).quadTo(100.55988, 147.37537, 99.9052, 146.40486);
((GeneralPath)shapeText).quadTo(99.2538, 145.43105, 99.2538, 143.58871);
((GeneralPath)shapeText).quadTo(99.2538, 141.7398, 99.9052, 140.76929);
((GeneralPath)shapeText).quadTo(100.55988, 139.79549, 101.80016, 139.79549);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(108.23023, 140.58835);
((GeneralPath)shapeText).quadTo(107.4604, 140.58835, 107.0722, 141.33844);
((GeneralPath)shapeText).quadTo(106.68399, 142.08525, 106.68399, 143.58543);
((GeneralPath)shapeText).quadTo(106.68399, 145.08232, 107.0722, 145.83241);
((GeneralPath)shapeText).quadTo(107.4604, 146.5825, 108.23023, 146.5825);
((GeneralPath)shapeText).quadTo(109.00336, 146.5825, 109.39156, 145.83241);
((GeneralPath)shapeText).quadTo(109.77977, 145.08232, 109.77977, 143.58543);
((GeneralPath)shapeText).quadTo(109.77977, 142.08525, 109.39156, 141.33844);
((GeneralPath)shapeText).quadTo(109.00336, 140.58835, 108.23023, 140.58835);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(108.23023, 139.79549);
((GeneralPath)shapeText).quadTo(109.46723, 139.79549, 110.12192, 140.76929);
((GeneralPath)shapeText).quadTo(110.7766, 141.7398, 110.7766, 143.58871);
((GeneralPath)shapeText).quadTo(110.7766, 145.43105, 110.12192, 146.40486);
((GeneralPath)shapeText).quadTo(109.46723, 147.37537, 108.23023, 147.37537);
((GeneralPath)shapeText).quadTo(106.98995, 147.37537, 106.335266, 146.40486);
((GeneralPath)shapeText).quadTo(105.68387, 145.43105, 105.68387, 143.58871);
((GeneralPath)shapeText).quadTo(105.68387, 141.7398, 106.335266, 140.76929);
((GeneralPath)shapeText).quadTo(106.98995, 139.79549, 108.23023, 139.79549);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(112.558075, 147.07928);
((GeneralPath)shapeText).lineTo(112.558075, 146.17128);
((GeneralPath)shapeText).quadTo(112.93312, 146.34564, 113.31804, 146.44104);
((GeneralPath)shapeText).quadTo(113.70296, 146.53316, 114.07143, 146.53316);
((GeneralPath)shapeText).quadTo(115.05839, 146.53316, 115.578186, 145.8719);
((GeneralPath)shapeText).quadTo(116.10128, 145.20734, 116.17366, 143.86507);
((GeneralPath)shapeText).quadTo(115.887436, 144.28946, 115.446594, 144.51646);
((GeneralPath)shapeText).quadTo(115.00904, 144.74347, 114.47608, 144.74347);
((GeneralPath)shapeText).quadTo(113.37068, 144.74347, 112.72586, 144.0822);
((GeneralPath)shapeText).quadTo(112.084335, 143.42093, 112.084335, 142.27277);
((GeneralPath)shapeText).quadTo(112.084335, 141.15092, 112.75547, 140.4732);
((GeneralPath)shapeText).quadTo(113.426605, 139.79549, 114.54188, 139.79549);
((GeneralPath)shapeText).quadTo(115.81835, 139.79549, 116.492775, 140.76929);
((GeneralPath)shapeText).quadTo(117.1672, 141.7398, 117.1672, 143.58871);
((GeneralPath)shapeText).quadTo(117.1672, 145.3159, 116.33815, 146.34564);
((GeneralPath)shapeText).quadTo(115.51239, 147.37537, 114.117485, 147.37537);
((GeneralPath)shapeText).quadTo(113.74243, 147.37537, 113.35752, 147.2997);
((GeneralPath)shapeText).quadTo(112.9726, 147.22733, 112.558075, 147.07928);
((GeneralPath)shapeText).closePath();
((GeneralPath)shapeText).moveTo(114.54188, 143.96048);
((GeneralPath)shapeText).quadTo(115.21301, 143.96048, 115.60451, 143.50977);
((GeneralPath)shapeText).quadTo(115.996, 143.05905, 115.996, 142.27277);
((GeneralPath)shapeText).quadTo(115.996, 141.49307, 115.60451, 141.04236);
((GeneralPath)shapeText).quadTo(115.21301, 140.58835, 114.54188, 140.58835);
((GeneralPath)shapeText).quadTo(113.87074, 140.58835, 113.47595, 141.04236);
((GeneralPath)shapeText).quadTo(113.08446, 141.49307, 113.08446, 142.27277);
((GeneralPath)shapeText).quadTo(113.08446, 143.05905, 113.47595, 143.50977);
((GeneralPath)shapeText).quadTo(113.87074, 143.96048, 114.54188, 143.96048);
((GeneralPath)shapeText).closePath();
