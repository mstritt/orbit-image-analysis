 ...
 */
public class OrbitIcon implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(1, 0, 0, 1, -611.52203f, -766.17664f));
        ...
        // _0_0_0_0
        transformations.offer(g.getTransform());
        g.transform(new AffineTransform(1.0124582f, 0, 0, 1.0143442f, -7.411853f, -8.110316f));
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(613.8406372070312, 781.6573486328125), new Point2D.Double(629.1531372070312, 781.6573486328125), new float[]{0, 0.1283382f, 1}, new Color[]{new Color(0x54255C), new Color(0x7B3787), new Color(0xA54AB5)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, 10.309959f, 5.525599f)));
        g.fill(shape);
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(629.354736328125, 786.9873657226562), new Point2D.Double(630.4360961914062, 788.7323608398438), new float[]{0, 0.48661074f, 1}, new Color[]{new Color(0x9342A2), new Color(0x9A45AA), new Color(0x893D96)}, NO_CYCLE, SRGB, new AffineTransform()));
        g.fill(shape);
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(619.8778686523438, 734.8424072265625), new Point2D.Double(611.5894775390625, 742.0526123046875), new float[]{0, 1}, new Color[]{new Color(0xECD161), new Color(0x7FF9DF6E, true)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1.0230525f, 10.215023f, 12.223863f)));
        g.fill(shape);
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(613.0363159179688, 744.4335327148438), new Point2D.Double(623.0324096679688, 740.2142333984375), new float[]{0, 1}, new Color[]{new Color(0x443705), new Color(0xECD161)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1.0230525f, 10.215023f, 12.223863f)));
        g.fill(shape);
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(606.3485107421875, 758.4259033203125), new Point2D.Double(614.359130859375, 751.9657592773438), new float[]{0, 1}, new Color[]{new Color(0x1D2C5E), new Color(0x7D93D9)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1.0230525f, 10.215023f, 12.223863f)));
        g.fill(shape);
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(630.6192626953125, 782.3370971679688), new Point2D.Double(627.4911499023438, 782.8685913085938), new float[]{0, 1}, new Color[]{new Color(0x54255C), new Color(0x29396A)}, NO_CYCLE, SRGB, new AffineTransform()));
        g.fill(shape);
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(622.96533203125, 777.0225219726562), new Point2D.Double(622.4950561523438, 773.8612670898438), new float[]{0, 1}, new Color[]{new Color(0x29396A), new Color(0x443705)}, NO_CYCLE, SRGB, new AffineTransform()));
        g.fill(shape);
        ...
        g.setPaint(new RadialGradientPaint(new Point2D.Double(618.2529296875, 770.80029296875), 5.485732f, new Point2D.Double(618.2529296875, 770.80029296875), new float[]{0, 0.7092865f, 1}, new Color[]{new Color(0xE15665), new Color(0x8B2746), new Color(0x611B31)}, NO_CYCLE, SRGB, new AffineTransform(0.9657214f, -0.2590981f, 0.19412157f, 0.72085f, -118.12616f, 380.8827f)));
        g.fill(shape);
        ...
        g.setPaint(new RadialGradientPaint(new Point2D.Double(633.65283203125, 774.699951171875), 4.3230734f, new Point2D.Double(633.65283203125, 774.699951171875), new float[]{0, 1}, new Color[]{new Color(0x363436), new Color(0x641C32)}, NO_CYCLE, SRGB, new AffineTransform(-0.6764161f, -0.20700441f, 0.20498496f, -0.6673287f, 902.98254f, 1422.1576f)));
        g.fill(shape);
        ...
        g.setPaint(BLACK);
        g.setStroke(new BasicStroke(1.0114605f, 1, 1, 4));
        g.draw(shape);
        ...
        g.setStroke(new BasicStroke(1.011f, 1, 1, 4));
        g.draw(shape);
        ...
        g.setStroke(new BasicStroke(1.0114605f, 1, 0, 4));
        g.draw(shape);
        ...
        g.setPaint(new LinearGradientPaint(new Point2D.Double(626.9586791992188, 781.4070434570312), new Point2D.Double(627.0252685546875, 781.141357421875), new float[]{0, 1}, new Color[]{new Color(0xAD942B), new Color(0xAD942B, true)}, NO_CYCLE, SRGB, new AffineTransform(1, 0, 0, 1, 0.07089448f, -0.1415256f)));
        g.fill(shape);
        g.setPaint(BLACK);
        g.setStroke(new BasicStroke(1.0114605f, 1, 1, 4));
        g.draw(shape);
