 ...
 */
public class status_bar implements ResizableIcon {
...
stroke = new BasicStroke(0.23315462f,1,1,4.0f,null,0.0f);
shape = new Rectangle2D.Double(0.12402412295341492, -32.040157318115234, 31.793811798095703, 6.188369274139404);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.fill(shape);
paint = new Color(204, 204, 204, 255);
stroke = new BasicStroke(0.44268677f,1,1,4.0f,null,0.0f);
shape = new Rectangle2D.Double(0.44598472118377686, 1.9708387851715088, 31.584280014038086, 22.45705795288086);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.58909035f,1,1,4.0f,null,0.0f);
shape = new Rectangle2D.Double(1.3384934663772583, 27.594141006469727, 12.718411445617676, 2.751638650894165);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.fill(shape);
paint = new Color(255, 255, 255, 255);
stroke = new BasicStroke(0.44150865f,1,1,4.0f,null,0.0f);
shape = new Rectangle2D.Double(15.933159828186035, 27.50364875793457, 6.703203201293945, 2.9326252937316895);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.fill(shape);
paint = new Color(255, 255, 255, 255);
stroke = new BasicStroke(0.42387903f,1,1,4.0f,null,0.0f);
shape = new Rectangle2D.Double(24.4438419342041, 27.600162506103516, 6.1416473388671875, 2.9502549171447754);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIcon of(int width, int height) {
       status_bar base = new status_bar();
       base.width = width;
       base.height = height;
       return base;
    }
