 ...
 */
public class lineal implements ResizableIcon {
...
g.transform(new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, -5.9835076332092285f, -6.110233306884766f));
// _0_0
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
AffineTransform defaultTransform__0_0_0 = g.getTransform();
g.transform(new AffineTransform(1.095768928527832f, -0.6090567111968994f, 0.8150297999382019f, 1.4663400650024414f, 0.14239943027496338f, 9.574407577514648f));
// _0_0_0
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
...
// _0_0_0_1
paint = new Color(0, 0, 0, 255);
stroke = new BasicStroke(0.4085787f,1,1,4.0f,null,0.0f);
