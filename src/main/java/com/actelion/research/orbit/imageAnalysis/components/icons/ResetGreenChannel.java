 ...
 */
public class ResetGreenChannel implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_0
        shape = new Rectangle2D.Double(83.50733184814453, 241.0528564453125, 119.99999237060547, 120);
        g.setPaint(GREEN);
        g.fill(shape);
