 ...
 */
public class ToggleMarkupDisabled implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.setPaint(RED);
        g.setStroke(new BasicStroke(77.278534f, 0, 0, 4));
        g.draw(shape);
