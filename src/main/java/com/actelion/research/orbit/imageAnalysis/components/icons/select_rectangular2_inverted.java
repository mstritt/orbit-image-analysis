 ...
 */
public class select_rectangular2_inverted implements ResizableIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private select_rectangular2_inverted() {
    ...
    public static ResizableIcon of(int width, int height) {
       select_rectangular2_inverted base = new select_rectangular2_inverted();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return select_rectangular2_inverted::new;
    }
}
