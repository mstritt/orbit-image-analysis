 ...
 */
public class obj_classification implements ResizableIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static ResizableIcon of(int width, int height) {
       obj_classification base = new obj_classification();
       base.width = width;
       base.height = height;
       return base;
    }
