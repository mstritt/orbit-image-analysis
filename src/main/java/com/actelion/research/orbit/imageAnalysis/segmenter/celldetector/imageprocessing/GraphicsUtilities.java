...
public class GraphicsUtilities {
   ...
   * @param image
   *          the reference image from which the dimension and the transparency of the new image are
   *          obtained
   ...
   * {@link #createThumbnail(BufferedImage, int, int)} should be used instead to ensure the quality
   ...
   *           if <code>newSize</code> is larger than the largest dimension of <code>image</code> or
   *           &lt;= 0
   */
   ...
   *           code>newHeight</code> is larger than the height of <code>image</code> or if one of
   *           the dimensions is &lt;= 0
   */
  public static BufferedImage createThumbnailFast(BufferedImage image, int newWidth,
      int newHeight) {
   ...
   * {@link #createThumbnailFast(BufferedImage, int)} when the new size is less than
