...
public class ClassificationMapReduceFullImage implements IMapReduce<String, Integer, ClassificationResult> {

    private OrbitModel model = null;
    private final transient static Logger logger = LoggerFactory.getLogger(ClassificationMapReduceFullImage.class);
