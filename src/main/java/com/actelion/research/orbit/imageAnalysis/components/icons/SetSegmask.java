 ...
 */
public class SetSegmask implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.setStroke(new BasicStroke(8.1386175f, 1, 2, 4));
        g.draw(shape);
