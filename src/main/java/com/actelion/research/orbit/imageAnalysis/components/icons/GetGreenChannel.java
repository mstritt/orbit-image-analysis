 ...
 */
public class GetGreenChannel implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.setPaint(GREEN);
        g.fill(shape);
        g.setStroke(new BasicStroke(1.3942702f, 0, 0, 4));
        g.draw(shape);
        ...
        // _0_0_3
        shape = new Ellipse2D.Double(117.11587524414062, 255.15679931640625, 44, 40);
        g.setPaint(MAGENTA);
        g.fill(shape);

        // _0_0_4
        shape = new Ellipse2D.Double(159.45187377929688, 243.99905395507812, 40, 44);
        g.setPaint(new Color(0x66FF00));
        g.fill(shape);

        // _0_0_5
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(145.44489, 278.0147);
        ((GeneralPath) shape).curveTo(145.44489, 338.0147, 145.44489, 338.0147, 145.44489, 338.0147);
        ((GeneralPath) shape).lineTo(125.44488, 318.0147);
        ((GeneralPath) shape).lineTo(145.44489, 338.0147);
        ((GeneralPath) shape).lineTo(165.44489, 318.0147);

        g.setPaint(new Color(0xB3B3B3));
        g.setStroke(new BasicStroke(8, 1, 1, 5.5f));
        g.draw(shape);
