...
//				
//		g.fillPolygon(new int[] {getWidth()-12, getWidth()-4, getWidth()-8}, new int[] {6, 6, 13}, 3 );
//		g.fillPolygon(new int[] {getWidth()-12, getWidth()-4, getWidth()-8}, new int[] {13, 13, 20}, 3 );
//	}
    ...
    public void paint(Graphics graphics) {
        ...
        Color bg0 = JComboCheckBox.getColor(246, 248, 250);
        Color bg1 = JComboCheckBox.getColor(170, 190, 207);
        Color bg2 = JComboCheckBox.getColor(187, 208, 227);
        ...
        if (!isEnabled()) {
            ...
            bg0 = JComboCheckBox.getColor(143, 169, 192);
            bg1 = JComboCheckBox.getColor(63, 108, 147);
            bg2 = JComboCheckBox.getColor(90, 139, 182);
            fg = Color.WHITE;
        }
        ...
        g.fillRect(getWidth() - (insets.right - 3), getHeight() / 2, (insets.right - 6), getHeight() / 2 - (insets.bottom - 3));
        g.setColor(JComboCheckBox.getColor(139, 160, 179));
