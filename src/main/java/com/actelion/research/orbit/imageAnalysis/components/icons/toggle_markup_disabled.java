 ...
 */
public class toggle_markup_disabled implements ResizableIcon {
...
stroke = new BasicStroke(77.278534f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(640.28156, 376.43985);
((GeneralPath)shape).lineTo(49.00416, 1011.8561);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.setTransform(defaultTransform_);
	 ...
	 */
	private toggle_markup_disabled() {
    ...
    public static ResizableIcon of(int width, int height) {
       toggle_markup_disabled base = new toggle_markup_disabled();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return toggle_markup_disabled::new;
    }
}
