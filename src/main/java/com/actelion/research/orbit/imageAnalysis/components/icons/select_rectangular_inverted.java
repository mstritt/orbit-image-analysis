 ...
 */
public class select_rectangular_inverted implements ResizableIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private select_rectangular_inverted() {
    ...
    public static ResizableIcon of(int width, int height) {
       select_rectangular_inverted base = new select_rectangular_inverted();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return select_rectangular_inverted::new;
    }
}
