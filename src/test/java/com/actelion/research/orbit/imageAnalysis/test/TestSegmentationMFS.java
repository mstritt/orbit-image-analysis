...
/**
 * Mumford-Shah segmentation test
 */
public class TestSegmentationMFS {
    ...
    public void testObjectSegmentation() throws OrbitImageServletException {
        OrbitModel model = OrbitModel.LoadFromInputStream(this.getClass().getResourceAsStream("/resource/testmodels/segmentation-mfs.omo"));
